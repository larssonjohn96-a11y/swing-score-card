...
const steps = [
  {
    title: "Välj din bunker",
    text: "Jag är Alma! Välj en plats i bunkern och en flagga. Du behöver inte mäta avståndet.",
  },
  {
    title: "Slå tre bollar. Gå sedan upp.",
    text: "Registrera var varje boll hamnade. På green ger poäng!",
  },
  {
    title: "Samla stjärnor. Höj ditt snitt.",
    text: "Gå tillbaka, kratta och slå tre till. Sex slag, max sex stjärnor.",
  },
];
export function BunkerOnboarding({ onDone, onClose }: { onDone: () => void; onClose: () => void }) {
  ...
  return (
    ...
    >
      <DialogContent className="w-[calc(100%_-_2rem)] max-w-md rounded-3xl bg-white p-5 text-slate-950">
        ...
        >
          {step === 2 ? "Starta första omgången" : "Nästa"}
        </button>
        {step < 2 && (
