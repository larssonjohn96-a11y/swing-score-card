...
import { COURSE_DISTANCES, holeStars, maxStars } from "@/lib/putt-course";
import { PuttStars as Stars } from "./putt-stars";
const positions = [
  [16, 27],
  [48, 25],
  [83, 27],
