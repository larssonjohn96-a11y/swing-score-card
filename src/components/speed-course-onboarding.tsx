...
const steps = [
  {
    title: "Hitta din fart",
    text: "Jag är Alma! Värm upp och ta fram din hastighetsmätare. Rundan har sex slag med driver.",
  },
  {
    title: "Ange bollhastigheten.",
    text: "Läs av bollhastigheten efter slaget. Välj mph eller km/h.",
  },
  {
    title: "Samla stjärnor. Höj ditt snitt.",
    text: "Samla 18 personliga stjärnor. Speedpoäng jämför dig med vänner. Paus efter tre slag.",
  },
];
export function SpeedOnboarding({ onDone, onClose }: { onDone: () => void; onClose: () => void }) {
  ...
  return (
    ...
    >
      <DialogContent className="w-[calc(100%_-_2rem)] max-w-md rounded-3xl bg-white p-5 text-slate-950">
        ...
        >
          {step === 2 ? "Spela första slaget" : "Nästa"}
        </button>
        {step < 2 && (
