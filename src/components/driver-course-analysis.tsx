...
export function DriverCourseAnalysis({ round }: { round: CourseRound }) {
  ...
  const review = buildActivityReview({
    title: "Rundanalys",
    handicap: hcp,
    modelId: "driver-course-v1",
    outcomes: rows.map((r) => ({
      label: `Hål ${r.hole}`,
      context: "Driver · zon ±20 m",
      result: `${shotPoints(r.shot)} driverpoäng`,
    ...
    >
      ...
      <DialogContent className="!animate-none !fixed !inset-0 !left-0 !top-0 !h-[100dvh] !max-h-none !w-full !max-w-none !translate-x-0 !translate-y-0 !rounded-none !border-0 !p-0 !gap-0 overflow-hidden !bg-transparent text-slate-950 [&>button]:z-30 [&>button]:bg-white [&>button]:p-2">
        ...
        <DialogDescription className="sr-only">
          Ditt estimerade drives-handicap och slag för slag, grupperat per hål.
        </DialogDescription>
          ...
          <>
            ...
            >
              <div className="max-h-[85dvh] w-full max-w-md space-y-4 overflow-y-auto rounded-[26px] border border-slate-200 bg-white p-5 shadow-xl">
                <div>
                  <h2 className="text-2xl font-black">Estimerat driver-HCP</h2>
                ...
                <div className="grid grid-cols-2 gap-3 rounded-2xl bg-slate-50 p-3 text-center">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Driverpoäng · max 100</p>
                  </div>
                  <div>
                ...
                <div ref={groups} className="scroll-mt-5 space-y-3">
                  ...
                  {rows
                    ...
                    .map((r) => (
                      ...
                      >
                        <h4 className="bg-blue-50 p-3 font-black">Hål {r.hole} · zon ±20 m</h4>
                        <div className="space-y-2 p-3 text-sm">
                          <p className="font-bold">{formatApproachResult(r.shot)}</p>
