...
const steps = [
  { title: "Gå till första hålet", text: "Jag är Alma! Börja 2 m från hålet med en boll." },
  {
    title: "Putta tills bollen är i hål.",
    text: "Tryck på antalet puttar: 1, 2, 3 eller 4+. Färre puttar ger fler stjärnor.",
  },
  {
    title: "Samla stjärnor. Höj ditt snitt.",
    text: "Samla upp till 16 stjärnor på sex hål. Efter tre kan du pausa eller avsluta.",
  },
];
export function PuttOnboarding({ onDone, onClose }: { onDone: () => void; onClose: () => void }) {
