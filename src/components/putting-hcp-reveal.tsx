...
/**
 * "Vågen"-ögonblicket för Putting Test – exakt samma mönster som Approach-
 * pilotens ApproachHcpReveal: spänning byggs upp med en nedräkning och en
 * siffra som rullar innan det sammanslagna Putting HCP:et landar.
 */
export function PuttingHcpReveal({ hcp, onContinue }: { hcp: number; onContinue: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#0b1710] px-8 text-center text-white">
      <p className="text-xs font-semibold uppercase tracking-[0.35em] text-white/40">
        {stage === "done" ? "Din putting-nivå" : "Resultatet är klart"}
      </p>
