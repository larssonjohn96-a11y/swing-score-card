...
const STEPS = ["Puttarna sammanställda", "Jämfört med HCP-nivåer", "Putting-nivå beräknad"];

/**
 * Putting Test-flödets egen variant av "Beräknar din nivå" – exakt samma
 * mönster som Approach-pilotens ApproachProcessing, medvetet en egen
 * komponent istället för att röra den delade TestResultProcessing.
 */
export function PuttingProcessing({
  totalPutts,
  resultReady,
  onSeeResult,
}: {
