...
type TestRoute="/lagputt"|"/50-bollar"|"/8-bollar"|"/approach-pei-valj";
...
{category==="putting"?<div className="mt-4 space-y-3"><TestCard to="/lagputt" title="Lag putt" description="18 puttar från 8 till 22 meter. Signerad poäng per putt – lägre totalscore är bättre." meta="18 puttar · 8–22 meter"/><TestCard to="/50-bollar" title="50-bollsövningen" description="50 puttar från 1 till 5 meter. Räkna varje slag tills alla bollar är hålade och försök slå ditt personbästa." meta="50 bollar · par 72 · PB"/></div>:
category==="around-the-green"?<div className="mt-4 space-y-3"><TestCard to="/8-bollar" title="8-bollsövningen" description="Chip, pitch, lobb och bunker från åtta stationer. Fem varv." meta="40 slag · max 160 poäng"/></div>:
