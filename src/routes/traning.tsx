...
const TESTS: Record<Category, TestItem[]> = {
  ...
  putting: [
    ...
    { to: "/pga-tour-18-puttar", title: "PGA Tour Putting", description: "Tränar hela puttspelet med en mix från riktigt korta till riktigt långa puttar. Välj 9 hål eller fulla 18.", meta: "9 eller 18 hål · 0,6–16 m", skill: "Hela puttspelet" },
