...
const CATEGORIES = [
  ...
  { id: "approach", title: "Närmast flaggan", subtitle: "Inspel", description: "Slå mot samma mål från varierade avstånd. Närmast flaggan vinner." },
  { id: "off-the-tee", title: "Fairway", subtitle: "Driver", description: "Längsta godkända drive inom en 30 meter bred fairway vinner." },
] as const;

const MATCH_TYPES: Record<MatchCategory, Array<{ id: string; title: string; description: string }>> = {
  "off-the-tee": [
    { id: "fairway", title: "Fairway", description: "Längsta slaget inom den 30 m breda fairwaykorridoren vinner hålet." },
  ],
  approach: [
    { id: "closest", title: "Närmast flaggan", description: "Samma målavstånd för båda. Närmast flaggan vinner hålet." },
  ],
  "around-the-green": [
...
function generateChallenge(category: MatchCategory, typeId: string, mode: MatchMode, shortGameLies: ShortGameLie[] = ["fairway", "rough"], approachDistance?: number): Challenge {
  ...
  if (category === "approach") {
    ...
    return { eyebrow: "Närmast flaggan", title: `${d} m`, detail: `Samma mål för båda · närmast flaggan vinner${suffix}` };
  }
  ...
  return { eyebrow: "Off the Tee", title: "Fairway", detail: `Längsta slaget inom fairwaykorridoren vinner hålet${suffix}` };
}
