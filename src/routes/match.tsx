...
function MatchPlayPage() {
  ...
  const approachProximityPreview = Math.sqrt(approachLong * approachLong + approachLateral * approachLateral);
  ...
  function resetApproachInput() { setApproachLongDirection("short"); setApproachLong(0); setApproachLateralDirection("left"); setApproachLateral(0); }
  function addGuest() {
  ...
  function startMatch() {
    ...
    setHoles(nextHoles);
    setHoleIndex(0); setBlueStrokes(1); setRedStrokes(1); setBluePoints(null); setRedPoints(null); setApproachTurn("blue"); resetApproachInput(); setFinalText(""); setIsSubmitting(false); setTransitionMessage(null); setEditingHoleIndex(null); setReturnHoleIndex(null); setStep("play");
  }
  ...
  function reset() {
    ...
    setScoringMode("match"); setMatchLength(5); setHoles([]); setHoleIndex(0); setFinalText(""); setBlueStrokes(1); setRedStrokes(1); setBluePoints(null); setRedPoints(null); setShortGameLies([]); setApproachRanges([]); setApproachCustomMin(50); setApproachCustomMax(200); setApproachTurn("blue"); resetApproachInput(); setIsSubmitting(false); setTransitionMessage(null); setEditingHoleIndex(null); setReturnHoleIndex(null); setStep("players");
  }
  function back() {
